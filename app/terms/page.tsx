...
export const metadata = {
  ...
  description: "Nexora terms of service placeholder.",
};
      ...
      <section className="border-b border-theme py-24">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          ...
          <div className="mt-8 prose max-w-none text-muted">
            ...
            <p>These Terms of Service ("Terms") govern your use of Nexora's website and services. This is a template — please adapt it to your needs or seek legal counsel.</p>
            ...
            <p>You retain ownership of content you submit but grant Nexora a license to use it to provide the services.</p>
            <h3>4. Intellectual Property</h3>
            <p>All site content, branding, and designs are the intellectual property of Nexora or its licensors unless otherwise noted.</p>
            ...
            <p>Services are provided "as is" and Nexora disclaims warranties to the extent permitted by law. Liability is limited to the extent allowed by applicable law.</p>
            <h3>8. Governing Law</h3>
            <p>These Terms are governed by the laws of the jurisdiction where Nexora is registered.</p>
            <h3>9. Changes to Terms</h3>
            <p>We may update these Terms; material changes will be posted with a new effective date.</p>
            <h3>10. Contact</h3>
            <p>For questions about these Terms, contact info@nexora.co.ke.</p>
