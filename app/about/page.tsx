...
export const metadata = {
  title: "About Nexora - Kenya's Premium Software Development Studio",
  description: "Nexora is a leading digital agency in Mombasa, Kenya. We build premium websites, enterprise software, and digital solutions for ambitious Kenyan companies across all industries.",
};
    ...
    <main className="flex-1 bg-surface">
      <section className="border-b border-theme py-24">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 sm:px-8 lg:grid-cols-[1fr_0.8fr] lg:px-10">
          <div>
            <SectionHeading eyebrow="About Nexora" title="Kenya's premium digital studio building the future of business technology." description="Based in Mombasa, serving ambitious companies across Kenya. We combine strategy, design, and engineering to turn complex goals into powerful digital experiences that drive growth." />
      ...
      <section className="py-20">
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          <div className="rounded-[32px] border border-cyan-400/20 bg-gradient-to-br from-cyan-400/10 to-slate-900 p-10">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-300">Why choose Nexora</p>
